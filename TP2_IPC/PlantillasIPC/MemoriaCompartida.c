#define KEY ((key_t) (9999)) // MODIFICAR: 
#define CANT_PROCESOS 1      // MODIFICAR:
...
int main() {
    ...
    for (int i = 0; i < CANT_PROCESOS; i++) {
        ...
        // si hay varios hijos, que cada uno toque una parte distinta de ptr
        // (una fila, un campo propio) para no pisarse sin necesitar sincronización.
